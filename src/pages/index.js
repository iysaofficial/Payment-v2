...
export default function Home() {
  ...
  const generateFormData = (
    ...
    return {
      ...
      transaction_details: {
        order_id: uniqueId,
        gross_amount: formattedPrice.toString(),
      },
    };
  };
    ...
    <section className="">
      <div className="container">
        <div className="content">
          ...
          <br />
          <p>
            1. Mohon mengisi data yang diperlukan dengan benar dan
            memastikan tidak ada kesalahan penulisan. Pastikan juga bahwa data
            yang dikirim sudah final dan tidak mengalami perubahan.
          </p>
          <p>
          ...
          <form name="regist-form">
            ...
            <div className="user-details">
              ...
              <div class="input-box">
                ...
                <p>Notes : Masukan NISN / NIM dengan sesuai urutan nama ketua dan anggota tim, dengan format seperti berikut :</p>
                <h6>231700</h6>
                <h6>241700</h6>
                <h6>251700</h6>
                <textarea
            ...
            <div className="user-details">
              ...
              <div className="">
                <button className="" onClick={(e) => generatePaymentLink(e)}>
                  Create Payment Link
                </button>
              </div>
            </div>
            ...
            <div class="input-box">
              ...
              <div class="input-box">
                <label for="INFORMATION_RESOURCES" class="form-label"
                  >Sumber Informasi Kompetisi ISPC 2024</label>
                <select
                  type="text"
